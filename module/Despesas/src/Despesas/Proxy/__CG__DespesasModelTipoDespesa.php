 ...
 */
class TipoDespesa extends \Despesas\Model\TipoDespesa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Despesas\\Model\\TipoDespesa' . "\0" . 'id', '' . "\0" . 'Despesas\\Model\\TipoDespesa' . "\0" . 'descDespesa', 'inputFilter');
        }
